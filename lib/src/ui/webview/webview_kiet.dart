...
class WebviewKiet extends StatefulWidget {
  const WebviewKiet({super.key});

  @override
  _WebviewKietState createState() => _WebviewKietState();
}

class _WebviewKietState extends State<WebviewKiet> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Kiệt's InAppWebView Example"),
      ),
      body: InAppWebView(
